...
@inline function _diurnal_substep_forcing(
    ...
    return SnowpackStepForcing(
        ...
        coszm=forcing.coszm,
        has_coszm=forcing.has_coszm,
        cloud=forcing.cloud,
        has_cloud=forcing.has_cloud,
        dust_deposition=forcing.dust_deposition,
        has_dust_deposition=forcing.has_dust_deposition,
        z_sur_std=forcing.z_sur_std,
        has_z_sur_std=forcing.has_z_sur_std,
